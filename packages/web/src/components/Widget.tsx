      ...
      {({ open }) => (
        <>
          ...
          <div className="flex rounded-full justify-end cursor-pointer bg-transparent w-[8.1875rem] h-12 group">
            <Popover.Button
              aria-label="Feedback"
              className={`flex p-3 w-12 h-12 bg-brand hover:bg-brand-hover rounded-full group-hover:w-[8.1875rem] drop-shadow-[0_0.5rem_1.5rem_rgba(130,87,229,0.25)]  border-none transition-all duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-dark/surface-primary focus:ring-brand ${
                open && 'bg-brand-hover'
              }`}
            >
              <ChatTeardropDots
